...
<tr><td>
	...
	<div class="name" align="right"><a id="o-show" href="<?php echo $showall_url;?>"><?php echo $show_all; ?></a></div>
	<div class="name" align="right"><a id="o-write" href="<?php echo $isitesti; ?>"><?php echo $isi_testimonial; ?></a></div>
