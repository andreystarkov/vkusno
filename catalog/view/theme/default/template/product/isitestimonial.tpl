...
<div id="box-content">
  ...
  <style>
  #tm-form input, #tm-form textarea { max-width: 65%;}
  .content p { font-family: 'Open Sans Condensed'; font-size: 25px; font-style: italic; margin-bottom: 30px;}
  </style>
  <div class="middle">
	...
	<div class="content">
        <table width="100%" class="form" id="tm-form">
          <tr>
          ...
          <tr style="display: none">
			...
			<input type="text" name="city" value="Оренбург" />
		</td>
          </tr>
          <tr>
            <td>
